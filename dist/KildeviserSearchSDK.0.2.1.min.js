...
var KildeViserSearchSDK=function(){var e=function(e){var t={};return t.collectionId=e,t.controller=function(){t.vm.init(t.collectionId)},t.view=function(){return m("div",{"class":"kildeviser"},[t.ViewFilter(),m("button",{"class":"regularsubmit",onclick:function(){t.vm.search()}},"Find"),m("p",t.vm.status())])},t.vm=function(){var e={};return e.status=m.prop(""),e.init=function(t){this.collection=new Collection(t),e.collection=this.collection,this.collection.get()},e.search=function(){e.status(""),this.collection.search().then(function(t){if(t.length>0){{new URLBuilder}-1!=navigator.userAgent.indexOf("Safari")&&-1==navigator.userAgent.indexOf("Chrome")&&window.location.assign("http://www.kbharkiv.dk/kildeviser/#?collection="+this.collection.id()+"&item="+t[0].id);{var n="http://www.kbharkiv.dk/kildeviser/#?collection="+this.collection.id()+"&item="+t[0].id;window.open(n)}}else e.status("Ingen resultater fundet")}.bind(this))},e.focus=m.prop(void 0),e}(),t.ViewFilter=function(){return t.vm.collection.filters.map(function(e){return[m("div",{"class":"span12"},[m("select",{config:function(t){jQuery(t).select2({minimumResultsForSearch:5,theme:"classic",allowClear:!0,placeholder:e.placeHolder(),disabled:e.values.length>0?!1:!0,language:{noResults:function(){return"Ingen resultater"}}})},onchange:function(n){e.selectedValue(n.target.value),t.vm.collection.updateFilters(e.name(),e.selectedValue())},style:"width:80%; max-width:600px;"},[m("option",{},""),e.values.map(function(e){return m("option",{value:e},e)})]),m("p",[m("i",e.helpText())])]),m(".clearfix")]})},t},t={};return t.init=function(t,n){var i=new e(t),l="http://www.kbhkilder.dk/software/KildeviserSearchSDK/select2.css",o=encodeURIComponent(l);if(!document.getElementById(o)){var c=document.getElementsByTagName("head")[0],r=document.createElement("link");r.id=o,r.rel="stylesheet",r.type="text/css",r.href=l,r.media="all",c.appendChild(r)}m.module(document.getElementById(n),{controller:i.controller,view:i.view})},t}();