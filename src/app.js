		...
		KildeviserSearch.ViewFilter = function(){
			return KildeviserSearch.vm.collection.filters.map(function(filter, index) {
				return [
					m("div", {class:"span12"}, [
						m("select", { 
							config: function(elem){ jQuery(elem).select2({minimumResultsForSearch: 5, allowClear: true, placeholder: filter.placeHolder(), disabled: filter.values.length > 0 ? false : true, 'language': { noResults: function(){ return 'Ingen resultater';}}});},
							onchange: function(e){
